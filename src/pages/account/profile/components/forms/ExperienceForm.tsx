...
import { User_Profile, User_Profile_Set_Input, useUpdateUserProfileMutation } from "generated/graphql";
...
import { EXPERIENCE_SKILLS, industriesList, STARTUP_STATUS } from "utils/Constants";
...
const ExperienceForm = (userProfile: User_Profile): ReactElement<any> => {
    ...
    return (
        <Form
            ...
            isValid={isValid}
        >
            <Heading fontSize={'lg'} fontWeight={'medium'} color={'fpGrey.300'} pb={4}>
                Background details
			</Heading>
            <TextareaField
                id="background"
